...
<div class="content ml-3 mr-3 ">
    ...
    <form action="{{ route('admin.inventory.update', Crypt::encrypt($data->id)) }}" method="post"
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-white">Ubah Barang</h5>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="form-group focused">
                                        <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="category">
                                                ...
                                                <option value="Smartphone" {{$data->category == 'smartphone' ? 'selected' : ''}}>Smartphone</option>
