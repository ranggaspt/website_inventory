    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a style="text-decoration:none" href="{{route('admin.purchase.index')}}">Purchase Order</a></li>
                <li class="breadcrumb-item">Ubah Data</li>
            </ol>
        </nav>
    </div>

    <form action="{{ route('admin.purchase.update', Crypt::encrypt($data->id)) }}" method="post"
                                ...
                                <div class="mb-3">
                                    <div class="form-group focused">
                                        <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                                            ...
                                            value="{{ $data->file }}">
                                            <a href="{{url('admin/purchase/download/'.$data->id)}}" >{{$data->file}}</a>
                                            @if ($errors->has('file'))
                                            <span class="help-block">
