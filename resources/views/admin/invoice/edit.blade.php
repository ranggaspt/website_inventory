...
<div class="content ml-3 mr-3 ">
    ...
    <form action="{{ route('admin.invoice.update', Crypt::encrypt($data->id)) }}" method="post"
                                            ...
                                            <div>
                                                <select class="form-control" name="proforma_id" required>
                                                    ...
                                                    @forelse ($proformas as $proforma)
                                                        <option value="{{ $proforma->id }}" {{$data->proforma_id == $proforma->id ? 'selected' : ''}}>{{ $proforma->name }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                    ...
                                    <div class="form-group focused">
                                        <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                                            ...
                                            <input id="file" type="file" class="form-control" name="file" 
                                                value="{{$data->file}}">
                                                <a href="{{url('admin/invoice/download/'.$data->id)}}" >{{$data->file}}</a>
                                            @if ($errors->has('file'))
                                            <span class="help-block">
